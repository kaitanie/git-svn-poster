...
% our case and exaple image
We present example use case for Git (Fig.~1), a distributed version control tool \cite{torvalds} 
...
{\bf Fig.1}:~Gitk tool showing branchings and merging actions
performad during the developmet of the software.
\end{minipage}
